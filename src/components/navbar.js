    ...
    return (
        <>
            <ul className="navbar">
                ...
                <Link to={!isLoggedIn ? "/password/category" : "/category"} className={location.pathname === "/category" || location.pathname === "/password/category" ? "active" : ""}>
                    <li>
                ...
                <Link to={!isLoggedIn ? "/password/product" : "/product"} className={location.pathname === "/product" || location.pathname === "/password/product" ? "active" : ""}>
                    <li>
                ...
                <Link to={!isLoggedIn ? "/password/accountant" : "/accountant"} className={location.pathname === "/accountant" || location.pathname === "/password/accountant" ? "active" : ""}>
                    <li>
